 ...
 */
export function useWebGLRect(ref: React.RefObject<HTMLElement>) {
...
// Export the original version for components that need it
export { useWebGLRect as useWebGLRectOriginal } from './use-webgl-rect.original'