...
import './WeatherIconsSVG.scss'

const WeatherIconsSVG: React.FC = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" style={{ position: 'absolute' }}>
      ...
      {/* Sun */}
      <symbol id="sunny" viewBox="0 0 100 100">
      ...
      {/* Moon */}
      <symbol id="clear-night" viewBox="0 0 100 100">
      ...
      {/* Small Gray Cloud */}
      <symbol id="grayCloud" viewBox="0 0 100 100">
        <path d="M20,15 Q25,0 45,11 Q60,5 60,20 A30,15 5 1,1 20,15 Z" />
      </symbol>

      {/* White Cloud */}
      <symbol id="whiteCloud" viewBox="0 0 100 100">
        <path
          fill="url(#gradWhite)"
      ...
      <symbol id="thunderBolt">
        <path fill="gold" d="M15,0 L1,23 L8,23 L0,40 L15,19 L8,19Z" />
      </symbol>
      ...
      {/* Partly Cloudy Day */}
      <symbol id="partly-cloudy-day" viewBox="0 0 100 100">
        <use href="#sunny" x="-12" y="-18" />
        <use href="#grayCloud" className="small-cloud" fill="url(#gradGray)" />
        <use href="#whiteCloud" x="7" />
      </symbol>

      {/* Partly Cloudy Night */}
      <symbol id="partly-cloudy-night" viewBox="0 0 100 100">
        <use href="#clear-night" x="-20" y="-15" />
        <use href="#grayCloud" className="small-cloud" fill="url(#gradGray)" />
        <use href="#whiteCloud" x="7" />
      </symbol>

      {/* Cloudy */}
      <symbol id="cloudy" viewBox="0 0 100 100">
        <use href="#grayCloud" className="small-cloud" fill="url(#gradGray)" />
        <use href="#whiteCloud" x="7" />
      </symbol>

      {/* Rain - THIS IS THE CORRECT STRUCTURE */}
      <symbol id="rainy" viewBox="0 0 100 100">
        <use
          href="#grayCloud"
          x="25"
          y="10"
      ...
      {/* Thunderstorm */}
      <symbol id="thunderstorm" viewBox="0 0 100 100">
        <use href="#grayCloud" className="small-cloud" fill="url(#gradGray)" />
        <use
          href="#grayCloud"
          x="25"
          ...
          fill="url(#gradDarkGray)"
        />
        <use href="#thunderBolt" x="30" y="61" className="lighting animated infinite flash" />
        <use href="#whiteCloud" x="7" />
        <use
          href="#thunderBolt"
          x="45"
      ...
      {/* Snow */}
      <symbol id="snow" viewBox="0 0 100 100">
